    ...
    <section id="pricing" className="mt-16 scroll-mt-28">
      <motion.div initial={{opacity:0,y:18}} whileInView={{opacity:1,y:0}} viewport={{ once:true, amount:0.35 }} transition={{duration:0.5}} className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 px-6 py-14 text-white shadow-[0_20px_60px_rgba(61,191,108,0.24)] sm:px-10 sm:py-16">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          <p className="text-sm font-semibold uppercase tracking-[0.24em] text-white/75">Ready to start</p>
          <h3 className="mt-4 text-3xl font-bold tracking-tight sm:text-4xl">Start Managing Your Finances Better Today</h3>
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link to="/register" className="inline-flex items-center justify-center gap-2 rounded-full bg-white px-6 py-3.5 text-sm font-semibold text-primary-700 transition hover:-translate-y-0.5 hover:shadow-xl">
              Get Started Free
              <ArrowRightIcon className="h-4 w-4" />
            </Link>
            <a href="#analytics" className="inline-flex items-center justify-center rounded-full border border-white/25 bg-white/10 px-6 py-3.5 text-sm font-semibold text-white transition hover:-translate-y-0.5 hover:bg-white/15">
              Explore Dashboard
            </a>
          </div>
        </div>
