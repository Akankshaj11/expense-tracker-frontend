    ...
    <section id="pricing" className="mt-16 scroll-mt-28">
      <motion.div initial={{opacity:0,y:18}} whileInView={{opacity:1,y:0}} viewport={{ once:true, amount:0.35 }} transition={{duration:0.5}} className="relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 px-6 py-14 text-white shadow-[0_20px_60px_rgba(61,191,108,0.24)] sm:px-10 sm:py-16">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <h3 className="mt-4 text-2xl font-light tracking-tight sm:text-3xl">Start Managing Your Finances Better Today</h3>
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-7 text-white/80">A modern, premium finance experience designed to make your organization feel more structured, productive, and in control.</p>
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <a href="/login" className="inline-flex items-center justify-center rounded-full border border-white/12 bg-white/6 px-6 py-3.5 text-sm font-light text-white transition hover:-translate-y-0.5 hover:bg-white/12">
              Explore Dashboard
            </a>
          </div>
        </div>
