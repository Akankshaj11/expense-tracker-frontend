  ...
  return (
    <section className="mt-16 scroll-mt-28">
      <div className="max-w-2xl">
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-primary-600">Testimonials</p>
        <h3 className="mt-3 text-3xl font-bold tracking-tight text-[var(--text)] sm:text-4xl">Loved by teams that need clarity</h3>
      </div>
        ...
        {items.map((item, index)=> (
          <motion.article key={item.name} initial={{opacity:0,y:14}} whileInView={{opacity:1,y:0}} viewport={{ once:true, amount:0.35 }} transition={{delay:0.08*index, duration:0.45}} className="card-floating rounded-[1.75rem] p-6">
            <div className="flex items-center gap-4">
              <div className="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-primary-100 to-primary-200 text-primary-700 font-semibold">
