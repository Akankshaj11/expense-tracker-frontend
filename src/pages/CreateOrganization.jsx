...
export default function CreateOrganization() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-blue-50 via-white to-sky-100 px-4 py-12 sm:px-6 lg:px-8">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-24 left-0 h-72 w-72 rounded-full bg-blue-200/35 blur-3xl" />
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {moduleItems.map((module) => {
                  ...
                  return (
                    <div
                      key={module}
                      className={`rounded-2xl border p-4 transition ${isSelected ? 'border-blue-500 bg-blue-50' : 'border-slate-200 bg-white'}`}
                    >
                      <label className="flex cursor-pointer items-center justify-between gap-4">
                        <div>
                          {isCustom ? (
                            <div className="inline-flex max-w-[240px] rounded-xl border-2 border-dashed border-blue-300 bg-blue-50/70 px-2 py-1.5 transition focus-within:border-blue-500 focus-within:bg-white">
                              <input
                                type="text"
                            ...
                            <div>
                              ...
                              <div className="flex gap-2">
                                ...
                                <button
                                  ...
                                  className="inline-flex shrink-0 items-center justify-center rounded-xl border border-blue-200 bg-blue-50 px-3 text-blue-600 transition hover:bg-blue-100"
